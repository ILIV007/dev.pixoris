// =========================================================
// Pixoris CMS Worker API v3.1 — Refactored with Service Layer
// =========================================================
// v3.1 Changes:
//   • FIXED: GitHub 403 "Missing User-Agent header" — all GitHub
//     API calls now go through services/github.js which always
//     includes the mandatory User-Agent header.
//   • REFACTOR: Modular backend structure
//       src/services/github.js     — unified GitHub API client
//       src/services/storage.js    — storage abstraction
//       src/utils/response.js      — unified response helpers
//       src/utils/logger.js        — structured logging
//       src/middleware/auth.js     — JWT + role-based access
//       src/middleware/rateLimit.js — login/upload rate limiting
//   • ADDED: Retry logic on transient failures (5xx, network)
//   • ADDED: Fallback mode when GitHub is unavailable
//   • ADDED: Proper error normalization (codes + messages)
//   • KEPT: All v3.0 features (debug API, caching, timing)
